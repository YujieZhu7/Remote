...
while steps < max_steps + 1:
    ...
    episodes += 1
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/RanNoise0.1/{method}/EnsSize_{ensemble_size}_S{seed}_score", score_history)
