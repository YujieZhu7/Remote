...
while steps < max_steps + 1:
    ...
    episodes += 1
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden4/DropoutRate0.01/{method}/0.5+1EnsSize_{ensemble_size}_S{seed}_score", score_history)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden4/DropoutRate0.01/{method}/0.5+1EnsSize_{ensemble_size}_S{seed}_success", success_history)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden4/DropoutRate0.01/{method}/0.5+1EnsSize_{ensemble_size}_S{seed}_demoaccept",
        average_accept_demos)
