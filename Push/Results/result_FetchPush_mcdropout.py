...
mcdropout_lcb_demoAccept2 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/DropoutRate0.01/LCB/0.5+1EnsSize_2_S5_demoaccept.npy")
...
plt.plot(x, mcdropout_lcb_demoAccept2[:4000:20], color='black', label='mcdropout_lcb_0.01')
plt.title('Acceptance rate of demonstrations')
plt.xlabel('Environment interactions (2e6)')
plt.ylabel('Acceptance rate')
plt.legend()
