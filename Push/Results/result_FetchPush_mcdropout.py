...
mcdropout_first_score = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/DropoutRate0.01/First/0.5+1EnsSize_2_S5_score.npy")
mcdropout_first_score2 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden4/DropoutRate0.01/First/0.5+1EnsSize_2_S5_score.npy")
...
plt.plot(x, mcdropout_first_score[:4000:20], color='orange', label='mcdropout_first_2hidden')
plt.plot(x, mcdropout_first_score2[:4000:20], color='red', label='mcdropout_first_4hidden')
...
mcdropout_first_demoAccept = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/DropoutRate0.01/First/0.5+1EnsSize_2_S5_demoaccept.npy")
mcdropout_first_demoAccept2 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden4/DropoutRate0.01/First/0.5+1EnsSize_2_S5_demoaccept.npy")
...
plt.plot(x, mcdropout_first_demoAccept[:4000:20], color='orange', label='mcdropout_first_2hidden')
plt.plot(x, mcdropout_first_demoAccept2[:4000:20], color='red', label='mcdropout_first_4hidden')
